...
parser.add_argument('--cons_w', type=float, default=0,
                    help='The weight of H consistency')
...
parser.add_argument('--usegmm', type=str2bool, default=False,
                    help='use gmm compress or not')
